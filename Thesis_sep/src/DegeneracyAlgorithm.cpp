...
DegeneracyAlgorithm::DegeneracyAlgorithm(vector<list<int>> const &adjacencyList, map<int,int> &ordering, map<int,int> &backmap, unordered_set<int> &partition, map<int,int> &remapping, int flag)
...
long DegeneracyAlgorithm::listAllMaximalCliquesDegeneracy(vector<list<int>> const &adjList, int size, map<int,int> &degeneracyOrdering, map<int,int> &backmap, unordered_set<int> &partition, map<int,int> &remapping, int flag)
{
...
////    clock_t clockStart = clock();
    NeighborListArray** orderingArray = computeDegeneracyOrderArrayNew(adjList, size, degeneracyOrdering, backmap, remapping, flag);
////    clock_t clockEnd = clock();
////    clock_t timeDegeneracyOrder = clockEnd - clockStart;
    ...
    cout << "Time for listing all maximal cliques: " << duration << '\n';
