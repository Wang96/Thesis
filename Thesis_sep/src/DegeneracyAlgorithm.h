...
{
public:
    DegeneracyAlgorithm(std::vector<std::list<int>> const &adjacencyList, std::map<int,int> &ordering, std::map<int,int> &backmap, std::unordered_set<int> &partition, std::map<int,int> &remapping, int flag);
    ...
    long listAllMaximalCliquesDegeneracy(std::vector<std::list<int>> const &adjList, int size, std::map<int,int> &degeneracyOrdering, std::map<int,int> &backmap, std::unordered_set<int> &partition, std::map<int,int> &remapping, int flag);
