...
NeighborListArray** computeDegeneracyOrderArrayNew(std::vector<std::list<int>> const &adjList, int size, std::map<int,int> &degeneracyOrdering, std::map<int,int> &backmap, std::map<int,int> &remapping, int flag);
